...
-- ALTER ROLE "authenticator" WITH NOINHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:sq8GnTbWLOFJbNXWIHk2Ng==$xpgCRzT0glgh5+uNIPyzbVIUoEuzVv+KzhuR8ypjQSo=:1nF8d9aw7hgwjF6k8UW3R/R8PxftwHztp+KV5llbQjA=';
-- CREATE ROLE "dashboard_user";
-- ALTER ROLE "dashboard_user" WITH INHERIT CREATEROLE CREATEDB NOLOGIN REPLICATION NOBYPASSRLS;
-- CREATE ROLE "pgbouncer";
-- ALTER ROLE "pgbouncer" WITH INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:HxDY0cJYj15SIIpMibV/xg==$mIpOL+jbbyIgAvr2RtJkJXM5QcA4MskpUyR/ah/u37k=:4TU9Ks4e8EDHvab0iuvkpryg5Y8ynOCZ6jVrJOgvP7I=';
-- CREATE ROLE "postgres";
-- ALTER ROLE "postgres" WITH INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:GSz9wd4PWQVU6iQaltWNwg==$GXhJeJKZw6UQ4qKfToWF4/Z5XSRozBX5IKP78Nbqg2w=:m7PzIfvha93rRcIjmOY6kzmt0ewQPo2rB5XpBuKOI9Y=';
-- CREATE ROLE "service_role";
-- ALTER ROLE "service_role" WITH INHERIT NOCREATEROLE NOCREATEDB NOLOGIN BYPASSRLS;
-- CREATE ROLE "supabase_admin";
-- ALTER ROLE "supabase_admin" WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:OS/WZJcQC/5FuxtVO030hg==$m7yw2+J+9Bbj1Djxb2iH7Kgv24se7asnqwjPnbW9Tsw=:5BizWPo4RpnHdbb2QcJIxBR6b9uV3NgTivBYL00uTTs=';
-- CREATE ROLE "supabase_auth_admin";
-- ALTER ROLE "supabase_auth_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:RsW3cYBVu1nRL+hXT4BpzQ==$+tdZdg6xOxFgWC0i8BjS2JRdNvf9SOE5MGsg1kqWstc=:u1rWMKsieY+FLkPn5EYuCNNTaVj5g54Na7Jc2PHNdL0=';
-- CREATE ROLE "supabase_functions_admin";
-- ALTER ROLE "supabase_functions_admin" WITH SUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:mUzznSNgjPPBE8zk3XGRxw==$grZcUSgmydWCfNn2VixtkMKV/GwqG8Gli5W24rQVeFQ=:Xpt3eqUyiQuyTT9mMWs8l0hhW1xptwOuC1V2vIVnhns=';
...
-- ALTER ROLE "supabase_storage_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:x9OnY3WFL0/4kwVBF7hRBg==$kbR42n9jR/4mBLzjoK2qEuxO7M3pARxm5cqBqHZlQFw=:1w2R7G2rx4LzP6ZO24O4crmkwictIEbkrXaXvgWnR80=';
...
--
-- Name: activate_code_anonymous("text"); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: activate_code_anonymous("text", "text"); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: activate_invitation_code("text", "uuid", integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: bind_yucode("text"); Type: FUNCTION; Schema: public; Owner: -
--
...
BEGIN
  ...
  SET status = 'used',
      ...
      -- Sync nickname if available from profile
...
--
-- Name: increment_api_call(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: idx_corrections_hsk_level; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_corrections_practice; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_corrections_user_module; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_profiles_membership; Type: INDEX; Schema: public; Owner: -
--
...
ALTER TABLE ONLY "public"."corrections"
    ADD CONSTRAINT "corrections_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;


--
-- Name: invitation_codes invitation_codes_bound_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."invitation_codes"
    ADD CONSTRAINT "invitation_codes_bound_user_id_fkey" FOREIGN KEY ("bound_user_id") REFERENCES "auth"."users"("id") ON DELETE SET NULL;


--
-- Name: learning_plans learning_plans_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."learning_plans"
    ADD CONSTRAINT "learning_plans_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
--
-- Name: invitation_codes Admins full access to invitation_codes; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: corrections Users can delete own corrections; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: corrections Users can insert own corrections; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: learning_plans Users can insert own plans; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: corrections Users can view own corrections; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: learning_plans Users can view own plans; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: invitation_codes Users can view their bound code; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: invitation_codes 可查询未使用邀请码; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: profiles 管理员可改所有用户; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: invitation_codes 管理员可查全部邀请码; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: profiles 管理员可查所有用户; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: invitation_codes 管理员可管理邀请码; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: objects Anyone can upload files; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Anyone can view files; Type: POLICY; Schema: storage; Owner: -
--
...
uploads	uploads	\N	2026-05-30 17:32:09.770621+00	2026-05-30 17:32:09.770621+00	t	f	\N	\N	\N	STANDARD
\.
